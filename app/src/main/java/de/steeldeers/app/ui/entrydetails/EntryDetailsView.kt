...
package de.steeldeers.app.ui.entrydetails
...
import de.steeldeers.app.data.entities.EntryWithFeed
import de.steeldeers.app.data.utils.PrefConstants
import de.steeldeers.app.utils.FILE_SCHEME
import de.steeldeers.app.utils.HtmlUtils
import de.steeldeers.app.utils.UTF8
import de.steeldeers.app.utils.getPrefBoolean
import de.steeldeers.app.utils.getPrefString
            ...
            override fun shouldOverrideUrlLoading(view: WebView, url: String): Boolean {
                try {
                    if (url.startsWith(FILE_SCHEME)) {
                        ...
                        val contentUri = getUriForFile(context, "de.steeldeers.app.fileprovider", file)
