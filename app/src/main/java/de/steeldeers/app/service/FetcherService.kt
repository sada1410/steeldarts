...
package de.steeldeers.app.service
...
import de.steeldeers.app.App.Companion.context
import de.steeldeers.app.data.entities.Entry
import de.steeldeers.app.data.entities.Feed
import de.steeldeers.app.data.entities.Task
import de.steeldeers.app.data.entities.toDbFormat
...
class FetcherService : IntentService(FetcherService::class.java.simpleName) {
    ...
    companion object : AnkoLogger {
        ...
        const val ACTION_REFRESH_FEEDS = "de.steeldeers.app.REFRESH"
        const val ACTION_MOBILIZE_FEEDS = "de.steeldeers.app.MOBILIZE_FEEDS"
        const val ACTION_DOWNLOAD_IMAGES = "de.steeldeers.app.DOWNLOAD_IMAGES"
                ...
                if (!MainActivity.isInForeground) {
                    ...
                    if (unread > 0) {
                        ...
                        val notifBuilder = NotificationCompat.Builder(context, channelId)
                                ...
                                .setAutoCancel(true)
                                .setContentTitle(context.getString(R.string.steeldeers_feeds))
                                .setContentText(text)
